...
public class DBUtil {
    ...
    private static final String connStr = "jdbc:sqlite:src/sample/Sample.DataBase/karsdb.db.db";
    ...
    public static ResultSet dbExecuteQuery(String queryStmt) throws SQLException, ClassNotFoundException {
        ...
        CachedRowSet crs = aFactory.createCachedRowSet() = null;
        try {
            ...
            //Har kommentert ut cahcedrowset funksjon som er deprecatedi java 17. Sliter med å få skrevet om denne.
            //RowSetFactory aFactory = RowSetProvider.newFactory();
